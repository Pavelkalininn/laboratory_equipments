...
from web.tests.core import (
    ...
    DATE_JUNE,
    DATE_AUGUST, MASS_EQUIPMENT_NAME, MASS_EQUIPMENT_TYPE,
    MASS_EQUIPMENT_MODEL, MASS_EQUIPMENT_MANUFACTURER,
    MASS_EQUIPMENT_NOMENCLATURE_KEY, MASS_EQUIPMENT_DOCUMENT_PATH
)
